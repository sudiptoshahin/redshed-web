...
export default function FreeShippingOnOrder() {
    ...
    return (
        <section id="freeshipping-on-order" className="mb-8">
            <div className="text-center w-full bg-[#ededed] h-auto">
                ...
                <div className="py-6">
                    ...
                    <button className="hover:bg-[#D50000] hover:text-white bg-white text-[#D50000] uppercase mx-4 p-2 my-2 xl:my-0">Join</button>
                </div>
            </div>
        </section>
    )
